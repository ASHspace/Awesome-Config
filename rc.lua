...
mymainmenu = awful.menu({ items = { --{ "awesome", myawesomemenu, beautiful.awesome_icon },
    				    ...
    				    { "Thunar", 'thunar' },
			            { "Main Menu", freedesktop.menu.build() },
                                  }
                        })
...
mytextclock = awful.widget.textclock('<b><span color="aqua"> %a %b %d, %I:%M %p </span></b>' )
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "0",                APW.ToggleMute),

    -- My Bindings
    awful.key({ modkey, 	  }, "F12", function () awful.util.spawn_with_shell("xflock4") end),
    --awful.key({ modkey, "Control", "#66"}, "l", function () awful.util.spawn_with_shell("xflock4") end)



   ----Display On
    --awful.key({ modkey,           }, "F10", function () awful.util.spawn_with_shell("xrandr --output LVDS1 --auto") end),
    awful.key({ modkey,           }, "F10", function () awful.util.spawn_with_shell("disper --cycle-stages='-s:-S' -C") end),

    ----Thunar
    awful.key({ modkey,           }, "F9", function () awful.util.spawn("thunar") end),

    ----Chrome
    awful.key({ modkey,           }, "F8", function () awful.util.spawn("google-chrome") end),
...
awful.util.spawn_with_shell("setxkbmap -option '' -option kpdl:dot")
...
-- Get the list of files from a directory. Must be all images or folders and non-empty. 
    ...
    wallpaperList = scanDir(".../Wallpaper/")
